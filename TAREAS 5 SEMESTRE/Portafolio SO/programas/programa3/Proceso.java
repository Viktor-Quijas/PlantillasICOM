...
public class Proceso {	
	...
	private int tiempoTranscurrido;		//	<-- Necesario para guardar el tiempo restante en caso de una interrupción
	
	private boolean bloqueado = false;
	
	private int tiempoLlegada = -1;
	...
	public void setTiempoMax(int tiempoMax) {
		...
		this.tiempoTranscurrido = tiempoMax;
	}
