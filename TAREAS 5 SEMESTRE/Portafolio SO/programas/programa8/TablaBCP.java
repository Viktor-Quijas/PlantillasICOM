...
public class TablaBCP extends JFrame{
	...
	public static final int PROCESADOR = 0;
	public static final int MEMORIA = 1;
	public static final int BLOQUEADOS = 2;
	public static final int SUSPENDIDOS = 3;
	public static final int A_REGRESAR = 4;
	public static final int TERMINADOS = 5;
	public static final int PROCESOS = 6;
	...
	public void IngresarDatosBCP(List<List<Proceso>> L, int contadorGlobal) {
		...
		for (int i = 0; i < L.size(); i++) {
			for (int j = 0; j < L.get(i).size(); j++) {
				...
				case SUSPENDIDOS: case A_REGRESAR:
					estado = "Suspendido";
					break;
