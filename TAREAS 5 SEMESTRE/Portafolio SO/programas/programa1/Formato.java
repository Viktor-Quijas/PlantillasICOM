...
public class Formato extends JDialog{
				...
				try {
					...
					if (!ids.contains(id) && id > 0) {
						...
						if (!(tiempoMax < 1)) {
							...
							if (!((operacion == 3 || operacion == 6) && y == 0)) {
	...
	public List<Lote> GetLista()		{ return listaLotes;			}		//Cambiando al método generarListaDeLotes() solo se necesita invocar este método para generar procesos aleatorios.
